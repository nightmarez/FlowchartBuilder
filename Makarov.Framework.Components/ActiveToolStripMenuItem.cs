// <copyright file="ActiveToolStripMenuItem.cs" company="Michael Makarov">
// Copyright Michael Makarov (c) 2008 All Right Reserved
// </copyright>
// <author>Michael Makarov</author>
// <email>m.m.makarov@gmail.com</email>
// <date>2009-03-04</date>
// <summary>Активный элемент меню.</summary>
...
{
    public sealed class ActiveToolStripMenuItem : ToolStripMenuItem, IActiveControl
    {
        /// <summary>
        /// Конструктор.
        /// </summary>
        ...
        public ActiveToolStripMenuItem(string text, string command)
            : base(text)
        {
            Tag = command;
        }
