// <copyright file="AlignHorizontalCenterCommand.cs" company="Michael Makarov">
// Copyright Michael Makarov (c) 2009 All Right Reserved
// </copyright>
// <author>Michael Makarov</author>
// <email>m.m.makarov@gmail.com</email>
// <date>2009-III-23</date>
// <summary>Команда - выровнять по центру по горизонтали.</summary>
...
{
    /// <summary>
    /// Команда - выровнять по центру по горизонтали.
    /// </summary>
    public sealed class AlignCenterHorizontalCommand : Command
    {
        /// <summary>
        /// Выполнить команду.
        /// </summary>
