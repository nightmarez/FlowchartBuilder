// <copyright file="Cross2.cs" company="Michael Makarov">
...
namespace Makarov.Framework.Graphics.Primitives
{
    ...
    public class Cross2 : Primitive
    {
        ...
        public Cross2(int x, int y, int width, int height)
        ...
        public Cross2(Point coords, Size size)
        ...
        public Cross2(System.Drawing.Rectangle rect)
