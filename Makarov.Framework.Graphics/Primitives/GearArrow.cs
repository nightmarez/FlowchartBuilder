// <copyright file="GearArrow.cs" company="Michael Makarov">
// Copyright Michael Makarov (c) 2008 All Right Reserved
// </copyright>
// <author>Michael Makarov</author>
// <email>m.m.makarov@gmail.com</email>
// <date>2009-10-05</date>
// <summary>Зубчатая стрелка.</summary>
...
namespace Makarov.Framework.Graphics.Primitives
{
    ...
    /// Зубчатая стрелка.
    /// </summary>
    public class GearArrow : Primitive
    {
        #region Constructors
        /// <summary>
        /// Конструктор.
        ...
        public GearArrow(int x, int y, int width, int height)
        ...
        public GearArrow(Point coords, Size size)
        ...
        public GearArrow(System.Drawing.Rectangle rect)
                ...
                new[]
                    {
                        ...
                        new PointF(x + (width >> 1), y + height - width / 6),
