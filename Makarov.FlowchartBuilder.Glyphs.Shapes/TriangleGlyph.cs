// <copyright file="TriangleGlyph.cs" company="Michael Makarov">
...
namespace Makarov.FlowchartBuilder.Glyphs.Shapes
{
    ...
    /// TriangleGlyph.
    /// </summary>
    [GlyphName("Треугольник")]
    public sealed class TriangleGlyph : AbstractShapeGlyph
    {
        /// <summary>
        ...
        protected override GraphicsPath CenteredPath
        {
            get
            {
                return new Framework.Graphics.Primitives.Triangle(
                    ScaledX, ScaledY,
